...
- 通过TCP去访问PLC设备，批量读取、单个读取、循环读取以及类型自动转换
- 支持添加需要记录/修改的变量，软件会自动展示到界面上

#### 软件架构
Kotlin

#### 部分截图
![输入图片说明](https://foruda.gitee.com/images/1747897795641772132/89a7fa77_8657183.png "屏幕截图")
![输入图片说明](https://foruda.gitee.com/images/1747897810082289380/b9cec984_8657183.png "屏幕截图")
